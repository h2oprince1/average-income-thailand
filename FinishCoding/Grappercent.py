...
def main():
    ...
    createpie_ghp(list58, "2558").render_to_file('graph_percen58.svg')
    createpie_ghp(list57, "2557").render_to_file('graph_percen57.svg')
    createpie_ghp(list56, "2556").render_to_file('graph_percen56.svg')
    createpie_ghp(list55, "2555").render_to_file('graph_percen55.svg')
...
def createpie_ghp(list_in, year):
    ...
    """
    pie_chart = pygal.Pie()
    pie_chart.title = ('ร้อยละคนต่อครัวเรือนที่มีรายได้ต่ำกว่า 30,000 บาท ปี %s (%%)' %year)
